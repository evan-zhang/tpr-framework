...
根据上下文（当前项目阶段、文件类型、用户意图）给出 2-3 个建议方案：
...
方案 B：保留原目录结构整体存放
└─ 全部上传到 → TPR/TPR-20260513-001/references/项目资料/
    （保留压缩包内的目录结构）
...
2. 上传完成后展示实际云端目录和文件清单：
   ...
   知识库路径：个人知识库 / TPR / TPR-20260513-001/
   
   📁 01-discovery/references/需求/
   ├─ PRD.md         ✅ (fileId: 30001)
   └─ 用户调研.md    ✅ (fileId: 30002)
   📁 04-execution/data/
   ├─ 市场数据.csv    ✅ (fileId: 30003)
   └─ 用户画像.xlsx  ✅ (fileId: 30004)
   📁 02-planning/references/
